...
#define MBEDTLS_ECP_BUDGET(ops) MBEDTLS_MPI_CHK(mbedtls_ecp_check_budget(grp, rs_ctx, (unsigned)(ops)));
 ...
 */
int mbedtls_ecp_point_read_binary(const mbedtls_ecp_group* grp, mbedtls_ecp_point* P, const unsigned char* buf,
                                  size_t ilen);
 ...
 */
int mbedtls_ecp_read_key(mbedtls_ecp_group_id grp_id, mbedtls_ecp_keypair* key, const unsigned char* buf,
                         size_t buflen);
