...
typedef struct mbedtls_x509_subject_alternative_name {
    ...
    union {
        ...
        mbedtls_x509_buf
            unstructured_name; /**< The buffer for the un constructed types. Only dnsName currently supported */
...
#define MBEDTLS_X509_CRT_ERROR_INFO_LIST                                                                               \
    ...
    X509_CRT_ERROR_INFO(MBEDTLS_X509_BADCRL_EXPIRED, "MBEDTLS_X509_BADCRL_EXPIRED", "The CRL is expired")              \
    X509_CRT_ERROR_INFO(MBEDTLS_X509_BADCERT_MISSING, "MBEDTLS_X509_BADCERT_MISSING", "Certificate was missing")       \
    ...
    X509_CRT_ERROR_INFO(MBEDTLS_X509_BADCRL_FUTURE, "MBEDTLS_X509_BADCRL_FUTURE", "The CRL is from the future")        \
 ...
 * \return         A negative error code on failure.
 */
typedef int (*mbedtls_x509_crt_ext_cb_t)(void* p_ctx, mbedtls_x509_crt const* crt, mbedtls_x509_buf const* oid,
 ...
 */
int mbedtls_x509write_crt_set_extension(mbedtls_x509write_cert* ctx, const char* oid, size_t oid_len, int critical,
