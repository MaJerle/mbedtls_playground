...
mbedtls_buffer_offset(unsigned char* p, size_t n) {
...
mbedtls_buffer_offset_const(const unsigned char* p, size_t n) {
    return (p == NULL ? NULL : p + n);
}
...
#define MBEDTLS_GET_UINT16_LE(data, offset) (((uint16_t)(data)[(offset)]) | ((uint16_t)(data)[(offset) + 1] << 8))
#endif
...
#define MBEDTLS_GET_UINT16_BE(data, offset) (((uint16_t)(data)[(offset)] << 8) | ((uint16_t)(data)[(offset) + 1]))
#endif
