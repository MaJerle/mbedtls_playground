...
struct mbedtls_pk_info_t {
    ...
    int (*check_pair_func)(const void* pub, const void* prv, int (*f_rng)(void*, unsigned char*, size_t), void* p_rng);
...
#if defined(MBEDTLS_RSA_C)
int mbedtls_pk_psa_rsa_sign_ext(psa_algorithm_t psa_alg_md, mbedtls_rsa_context* rsa_ctx, const unsigned char* hash,
